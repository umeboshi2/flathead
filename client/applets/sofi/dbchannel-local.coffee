...
AppChannel.reply 'get-sofi-config', (name) ->
  model = new BaseLocalStorageModel
    id: "cfg_#{name}"
  model.fetch()
  return model
...
#class SofiSettings extends BaseLocalStorageModel
#  id: 'sofi_settings'
#
#consumer_key = '4mhV8B1YQK6PUA2NW8eZZXVHjU55TPJ3UZnZGrbSoCnqJaxDyH'
#sofi_settings = new SofiSettings consumer_key:consumer_key

#AppChannel.reply 'get_sofi_settings', ->
#  sofi_settings
